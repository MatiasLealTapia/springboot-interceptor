package com.matias.curso.springboot.app.interceptor.springbootinterceptor.interceptors;
...
public class LoadingTimeInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        int delay = random.nextInt(500); // Crear delay para que se vea en el ejemplo.
        Thread.sleep(delay); // Crear delay para que se vea en el ejemplo.

        // PERSONALIZAR CUANDO ES FALSE:
